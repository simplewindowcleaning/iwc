...
export const SERVICE_AREAS: Record<string, ServiceArea> = {
  "95060": {
    zip: "95060", name: "Santa Cruz", center: [-122.0308, 36.9741], minWindows: 5,
    alert: {
      headline: "Area Details — 95060",
      notes: [
  ...
  "95062": { zip: "95062", name: "Live Oak",           center: [-121.9934, 36.9657], minWindows: 5 },
  "95003": { zip: "95003", name: "Aptos",              center: [-121.8956, 36.9771], minWindows: 5 },
  "95018": { zip: "95018", name: "Felton",             center: [-122.0721, 37.0513], minWindows: 5 },
  "95066": { zip: "95066", name: "Scotts Valley",      center: [-122.0130, 37.0508], minWindows: 5 },
  "95073": { zip: "95073", name: "Soquel",             center: [-121.9574, 36.9918], minWindows: 5 },
  "95064": { zip: "95064", name: "Santa Cruz (UCSC)",  center: [-122.0584, 36.9967], minWindows: 5 },
  "95065": { zip: "95065", name: "Pleasure Point",     center: [-121.9666, 36.9825], minWindows: 5 },
  "95010": { zip: "95010", name: "Capitola",           center: [-121.9527, 36.9750], minWindows: 5 },
};
